...
public class LoginController {
	...
	public ResponseEntity<EmployeeDetailsVO> login(@RequestBody LoginDetailsVO loginDetailsVo,HttpServletRequest request, HttpServletResponse response){
	...
	@RequestMapping(value = "/portalLogout", method = RequestMethod.POST, headers = "Accept=application/json", produces ="application/json")
	public ResponseEntity<EmployeeDetailsVO> logout(HttpServletRequest request, HttpServletResponse response) throws TravelServiceException{
		HttpSession session = request.getSession();
