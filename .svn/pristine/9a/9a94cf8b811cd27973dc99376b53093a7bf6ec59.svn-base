...
app.config(function($routeProvider){
    $routeProvider
        ...
        .when('/contactus',{
            templateUrl: 'resources/contactus.html',
...
app.factory('Person', ['$resource', function ($resource) {
    return $resource('http://localhost:8080/visaTravelRequest/info/person/:personId', {personId: '@pid'},
	{
