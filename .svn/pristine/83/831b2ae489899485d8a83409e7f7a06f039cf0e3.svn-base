...
public class RequestCountBO {
	...
	public String toString() {
		return "RequestCountBO [cabPending=" + cabPending + ", cabApproved=" + cabApproved + ", flightPending="
				+ flightPending + ", flightApproved=" + flightApproved + ", accomodationPending=" + accomodationPending
				+ ", accomodationApproved=" + accomodationApproved + ", forexPending=" + forexPending
				+ ", forexApproved=" + forexApproved + "]";
	}
