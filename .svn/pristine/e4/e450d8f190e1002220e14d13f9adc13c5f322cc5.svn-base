...
public class MainRequestDAOImpl implements MainRequestDAO {
	...
	public boolean cancelRequestDetailsByRequestId(MainRequestBO mainRequestBO) throws DAOException {
...
/*	*//**
	...
	*//**
	...
	{
		logger.info("MainRequestDAOImpl : isRequestIdValid: Started");
		logger.info("MainRequestDAOImpl : isRequestIdValid: Request Id: " + requestId);	
		try {
			logger.info("MainRequestDAOImpl : isRequestIdValid: Request Id: " + requestId);	
			Session session = getSessionFactory().getCurrentSession();
			String sql ="select requestId from MainRequestBO where requestId =:requestId";
			Query query = session.createQuery(sql);  
			query.setParameter("requestId", requestId); 
			...
			logger.info("MainRequestDAOImpl : isRequestIdValid: Ended");
		} catch (Exception e) {
			logger.error("MainRequestDAOImpl : isRequestIdValid: Exception Caught: " + e);
			throw new DAOException(e);
		}
		return false;
	}
