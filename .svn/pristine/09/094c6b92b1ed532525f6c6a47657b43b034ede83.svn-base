package com.capco.technologies.living.domain.interactor.base;

import com.capco.technologies.living.domain.executor.Executor;
import com.capco.technologies.living.domain.executor.MainThread;

/**
 * Created by Sachin Shelke on 8/4/15.
 * <p/>
