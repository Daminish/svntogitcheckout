...
public class FlightDetailsVO extends BaseVO{
	...
	public String toString() {
		return "FlightDetailsVO [requestId=" + requestId + ", tourType=" + tourType + ", travelType=" + travelType
				+ ", businessPurpose=" + businessPurpose + ", prefClass=" + prefClass + ", mealPref=" + mealPref
